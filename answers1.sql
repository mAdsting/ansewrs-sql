...
-- 3. Display firstName, lastName, and email of employees with job title 'Sales Rep', sorted by employeeNumber descending
...
-- 5. Fetch productName and quantityInStock from the products table, sorted by buyPrice ascending, limit 5 records
